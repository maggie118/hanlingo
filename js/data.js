...
(function() {
  ...
  // ============================================================
  var T1_CULTURE = '华人见面不习惯拥抱或贴面，微笑+点头即可。问"你怎么样？"时，对方若回答"还行"表示"so-so"，不必追问。初次见面递名片时，双手奉上更显尊重（新加坡/台湾通用）。';
  ...
  // ============================================================
  var T2_CULTURE = '在市场和夜市，讨价还价是正常，但高档商场不行。说"太贵了"后，卖家通常会主动降价。如果对方说"不能再便宜了"，就表示底价到了。块（kuài）和毛（máo）是口语中的"元"和"角"，新加坡人也用"块"指代新加坡元。';
  ...
  // ============================================================
  var T3_CULTURE = '在中国大陆和台湾，"买单"是通用的，在新加坡更常说"算账"或"结账"，但"买单"也听得懂。如果你不吃辣，一定要强调"不要辣"，因为很多菜默认放辣椒。用筷子时，不要把筷子竖插在米饭上（像祭拜），这是大忌。';
  ...
  // ============================================================
  var T4_CULTURE = '在新加坡，说"巴士"比"公交车"更普遍；在台湾说"公车"；在中国大陆说"公交车"。问路时最好先微笑说"打扰一下"（Dǎrǎo yīxià），以示礼貌。出租车司机大多会讲简单英语，但说中文更容易得到亲切回应。';
  ...
  // ============================================================
  var T5_CULTURE = '"你辛苦了"是职场万金油，用于感谢同事加班或协助，不是客气，而是共情。华人职场很重视"准时"，迟到要主动道歉。说"加油"是鼓励，比"Good luck"更热血。';
  ...
  // ============================================================
  var T6_CULTURE = '华人普遍相信"喝热水"对感冒有益，如果你要冰水，医生可能会皱眉。说"过敏"时要清晰，尤其是花生、海鲜，因为中餐常用这些食材。在药房可以说"有药吗"（Yǒu yào ma?），他们会帮忙。';
  ...
  // ============================================================
  var T7_CULTURE = '华人不太当众崩溃，用"累死了"是夸张说法，大家能接受。说"烦人"时语气要轻，否则显得攻击性。"想你"只用于亲密关系（家人、恋人），对普通朋友说会太肉麻，慎用。';
  ...
  // ============================================================
  var T8_CULTURE = '在新加坡和中国，扫码支付非常普遍，主动问"我扫你"是标准操作。如果对方说"扫我"，意思是让你打开摄像头扫他的二维码。要区分"Wi-Fi"和"流量"（liúliàng – mobile data）。';
  ...
  // ============================================================
  var T9_CULTURE = '华人酒店前台通常很礼貌，说"请"和"谢谢"会得到更好服务。如果空调太冷，可以直接说"调高一点"（tiáo gāo yīdiǎn）。退房时房卡归还即可，一般不会查房（除非贵重物品）。';
  ...
  // ============================================================
  var T10_CULTURE = '华人朋友间"抢着买单"是常见社交礼仪，但您说"我请客"会非常受欢迎。去朋友家做客，带点水果或小礼物是加分项。聚会结束发"我到家了"是必备安全礼貌，对方会觉得你靠谱。';
  ...
  // ============================================================
  var T11_CULTURE = '银行工作人员通常会讲英语，但用中文说"换钱"会更亲切。ATM取钱时先观察周围环境，输入密码时用手遮挡。如果卡被吞，立刻找银行柜员说"我的卡被吞了"，他们会帮你取出。';
  ...
  // ============================================================
  var T12_CULTURE = '华人社会"准时"被视为尊重，但社交场合（如饭局）可能允许迟到10分钟（俗称"弹性"）。商务会议则必须准时。说"哦"（ó）是友好语气词，增加亲切感。';
  ...
  // ============================================================
  var T13_CULTURE = '和华人聊天气是最安全的破冰话题，比聊政治、宗教好得多。在新加坡，大家常抱怨"太热"和"下雨"；在北方则聊"冷"。说"带伞了吗"是关心，显得贴心。';
  ...
  // ============================================================
  var T14_CULTURE = '当你说"我的中文不太好"时，华人通常会鼓励你，并自动放慢语速。大胆问"什么意思"是学习的好习惯。用"慢慢说"比"请说慢一点"更自然。';
  ...
  // ============================================================
  var T15_CULTURE = '报警时先说"帮帮我"吸引注意。华人警察或路人通常愿意协助，但尽量保持冷静。护照丢失要立刻联系大使馆，说"补办护照"（bǔbàn hùzhào）。最后一句"别担心，我没事"用来安抚他人，也让自己镇定。';
  ...
  var TOPICS_META = [
    ...
    { key: 'topic-02', icon: '🛍️', title: 'Numbers, Paying & Shopping',      desc: 'Ask price, bargain, pay with card — avoid getting overcharged.', cultureTip: T2_CULTURE },
    ...
    { key: 'topic-04', icon: '🗺️', title: 'Getting Around',                   desc: 'Ask directions, take taxi/bus, never get lost in a Chinese city.', cultureTip: T4_CULTURE },
    ...
    { key: 'topic-07', icon: '💗', title: 'Real Feelings & Emotions',        desc: 'Move past "I\'m fine" — share joy, stress, tiredness naturally.', cultureTip: T7_CULTURE },
    ...
    { key: 'topic-13', icon: '⛅', title: 'Weather, Seasons & Dressing',     desc: 'Small-talk like a local — the safest icebreaker in any Chinese context.', cultureTip: T13_CULTURE },
